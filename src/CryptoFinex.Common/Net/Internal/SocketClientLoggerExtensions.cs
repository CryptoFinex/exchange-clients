...
namespace CryptoFinex.Common.Net.Internal
{
    internal static class SocketClientLoggerExtensions
    {
        ...
        public static void ConnectionStateChanged(this ILogger logger, string connectionId, WebSocketConnection.ConnectionState previousState, WebSocketConnection.ConnectionState newState)
        {
            if (logger.IsEnabled(LogLevel.Debug))
            {
